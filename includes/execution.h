...
void			clean_up_function_multiple_commands(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			handle_multiple_commands_null_heredocs_input(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			handle_multiple_commands_heredocs_delimiter(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			handle_multiple_commands_heredocs_input(t_piping_multiple_command_params *params);
void			handle_heredocs_readline_multiple_commands(t_piping_multiple_command_params *params,
					char ***env, char *input);

// multiple_commands_utils4 //
void			handle_counters_pipe_closing_and_redirects_array(t_piping_multiple_command_params *params);
void			handle_redirect_array_for_heredocs(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			handle_heredocs_multiple_commands(t_piping_multiple_command_params *params,
					t_list *node, char ***env, char *input);

// multiple_commands_utils5 //
void			setting_up_input_redirections_multiple_commands(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			setting_up_output_redirections_multiple_commands(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			setting_up_heredocs_multiple_commands(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			setting_up_pipes_to_redirect_output(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			read_from_pipe_without_redirections(t_piping_multiple_command_params *params,
					char ***env, char *input);

// multiple_commands_utils6 //
void			handle_input_output_heredocs_multiple_commands(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			setup_pipe_redirection_and_closing(t_piping_multiple_command_params *params,
					char ***env, char *input);
void			handle_child_process(t_piping_multiple_command_params *params,
					char ***env, char *input);
...
// heredocs_utils2 //
void			handle_exit_conditions_for_heredocs(t_redirect_single_command_params *params,
					char ***env, char *input);
int				handle_execve_for_heredocs(t_redirect_single_command_params *params,
					char ***env, char *input);
int				handle_child_execution(t_redirect_single_command_params *params,
					char ***env, char *input);
...
void			finding_heredocs(t_redirect_single_command_params *params,
					t_list *node);
int				handling_no_heredocs(t_redirect_single_command_params *params,
					char ***env, char *input, t_list *node);
int				creating_pipes(t_redirect_single_command_params *params);
int				handling_heredocs(t_redirect_single_command_params *params,
					char ***env, char *input, t_list *node);
void			execution(t_list *node, char ***env, char *input);

// single_commands_utils1 //
void			handle_redirections_file_opening(t_redirect_single_command_params *params,
					char ***env, char *input);
...
void			clean_up_function(t_redirect_single_command_params *params,
					char ***env, char *input);
void			exiting_conditions_nonzero_pipecount(t_redirect_single_command_params *params,
					char ***env, char *input);
void			exiting_conditions_zero_pipecount(t_redirect_single_command_params *params,
					char ***env, char *input);

// single_commands_utils3 //
void			executing_execve_other_cases(t_redirect_single_command_params *params,
					char ***env, char *input);
void			handling_exit_conditions_other_cases(t_redirect_single_command_params *params,
					char ***env, char *input);
void			child_process_other_cases(t_redirect_single_command_params *params,
					char ***env, char *input);
int				handle_fork_plus_executing_child(t_redirect_single_command_params *params,
					char ***env, char *input);
...
int				handle_redirects(t_redirect_single_command_params *params,
					char ***env, char *input);
void			execute_child_process_for_redirections(t_redirect_single_command_params *params,
					char ***env, char *input);
